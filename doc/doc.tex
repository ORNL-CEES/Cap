...
This is basically \cite{Allu2014b} with current collector added and coupled to
thermal.
...
constant current 100 A over the range 1.1 V--2.2 V.
...
Red color denotes , green area represents the actual energy recovered at discharge
    }
    \label{fig:constant_current_cycling_power_density.png}
\end{figure}
...
1 hour of cycles charge/discharge at 100 A.
    }
    \label{fig:constant_current_cycling_temperature.png}
\end{figure}
...
Figure \ref{fig:series_of_constant_current_charge_and_constant_voltage_discharge}
illustrates that.
...
%-----------------------------------------------------------------------------
\section{Test case 4: constant power}
