...
enum CapacitorState { GalvanostaticCharge, GalvanostaticDischarge, PotentiostaticCharge, PotentiostaticDischarge, Initialize, Relaxation, CustomConstantCurrent, CustomConstantVoltage, CustomConstantLoad };
template <int dim>
